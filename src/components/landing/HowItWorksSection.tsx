  ...
  return (
    <Section id="how-it-works" className="bg-background px-6 pt-24 md:pt-32 pb-0 overflow-hidden">
      <div className="max-w-[1200px] mx-auto">
        ...
        {/* Cards + Image overlap container */}
        <div className="relative mt-16 md:mt-20">
          {/* Image first — cards will pull up over its white space */}
          ...
          {/* Desktop cards — pulled up to sit in image's white space */}
          <div className="hidden md:flex justify-center items-start gap-6 lg:gap-10 relative z-20 -mt-72 lg:-mt-80">
          ...
          {/* Mobile stacked */}
          <div className="md:hidden flex flex-col gap-5 relative z-20 -mt-32">
            {benefits.map((b, i) => (
