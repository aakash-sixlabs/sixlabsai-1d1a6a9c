  ...
  return (
    <Section id="how-it-works" className="bg-background px-6 pt-24 md:pt-32 pb-0 overflow-hidden">
      <div className="max-w-[1200px] mx-auto">
        ...
        {/* Cards row — staggered, overlap image below */}
        <div className="relative mt-10 md:mt-14">
          <div className="hidden md:flex justify-center items-start gap-6 lg:gap-10 relative z-20">
            ...
            <BenefitCard benefit={benefits[1]} index={1} offsetClass="translate-y-10" />
            <BenefitCard benefit={benefits[2]} index={2} offsetClass="translate-y-16" />
          </div>
          ...
          {/* Creatives image — cropped to remove blank top space */}
          <div className="relative -mt-20 md:-mt-32 lg:-mt-40 z-10 h-[300px] md:h-[360px] lg:h-[420px] overflow-hidden">
            <img
