...
/* ── Meta "infinity" logo with gradient ── */
const MetaLogo = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 36 20" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
    <defs>
    ...
    <path d="M7.04 16.44c-2.53 0-4.04-1.94-4.04-5.16 0-3.04 1.55-6.7 3.93-10.06C8.86-.52 11.3-1.5 13.2.82c1.1 1.34 1.76 3.32 2.86 5.52l1.6 3.2c1.16 2.32 2.12 3.82 3.7 3.82 2.06 0 3.46-2.58 3.46-5.42 0-2.04-.62-3.48-1.78-3.48-1.56 0-2.92 2.14-4.56 5.12l-1.22 2.2c-2.54 4.62-4.44 7.26-7.8 7.26-.9 0-1.6-.18-2.22-.52zm21.92-4.5c2.53 0 4.04 1.94 4.04 5.16 0 3.04-1.55 6.7-3.93 10.06-1.93 2.74-4.37 3.72-6.27 1.4-1.1-1.34-1.76-3.32-2.86-5.52l-1.6-3.2c-1.16-2.32-2.12-3.82-3.7-3.82-2.06 0-3.46 2.58-3.46 5.42 0 2.04.62 3.48 1.78 3.48 1.56 0 2.92-2.14 4.56-5.12l1.22-2.2c2.54-4.62 4.44-7.26 7.8-7.26.9 0 1.6.18 2.22.52z" fill="url(#meta-gradient)" transform="translate(0, 2) scale(0.95)" />
  </svg>
);
