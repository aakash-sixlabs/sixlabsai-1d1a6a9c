...
export const PdpInputStep = () => {
  const { setStep, updateState, state } = useWizard();
    ...
    <div className="container max-w-xl py-16">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
        ...
        <p className="text-muted-foreground mb-8">
          Paste the product page URL for the product you want to advertise.
        </p>
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="flex gap-2">
              {[
                { v: "single", l: "Single Image" },
                { v: "carousel", l: "Carousel" },
                { v: "auto", l: "Let System Decide" },
              ].map((o) => (
                <button
                  key={o.v}
          ...
          <div>
            ...
            <Textarea
              placeholder="e.g., focus on premium feel, highlight hydration benefit..."
              value={notes}
